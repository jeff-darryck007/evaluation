...
class __TwigTemplate_06270044546e8104ed9f2c3e966e9670 extends Template
{
    ...
    <section id=\"contact\" class=\"py-5 mt-5\">
        ...
        // line 50
        yield "                        ";
        if ((array_key_exists("recaptcha_site_key", $context) && (isset($context["recaptcha_site_key"]) || array_key_exists("recaptcha_site_key", $context) ? $context["recaptcha_site_key"] : (function () { throw new RuntimeError('Variable "recaptcha_site_key" does not exist.', 50, $this->source); })()))) {
            // line 51
            yield "                            <div class=\"g-recaptcha mb-3\"
                                 data-sitekey=\"";
            // line 52
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["recaptcha_site_key"]) || array_key_exists("recaptcha_site_key", $context) ? $context["recaptcha_site_key"] : (function () { throw new RuntimeError('Variable "recaptcha_site_key" does not exist.', 52, $this->source); })()), "html", null, true);
            yield "\">
                            </div>
                        ";
        } else {
            ...
            yield "                            <div class=\"alert alert-warning\">
                                ⚠️ reCAPTCHA non configuré (clé manquante)
                            </div>
                        ";
        }
        // line 59
...
";
    ...
    {
        return array (  189 => 72,  174 => 59,  168 => 55,  162 => 52,  159 => 51,  156 => 50,  130 => 27,  125 => 24,  119 => 20,  110 => 18,  106 => 17,  103 => 16,  94 => 14,  89 => 13,  79 => 5,  76 => 4,  63 => 3,  40 => 1,);
    }
            ...
            <div class=\"row justify-content-center\">
                <div class=\"col-md-8\">
                    ...
                    <form method=\"POST\" action=\"{{ path('app_contact') }}\" class=\"shadow p-4 rounded bg-light\">
                        ...
                        {# Sécurité CSRF (fortement recommandé) #}
