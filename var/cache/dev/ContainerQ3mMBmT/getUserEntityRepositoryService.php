...
class getUserEntityRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserEntityRepository.php';

        return $container->privates['App\\Repository\\UserEntityRepository'] = new \App\Repository\UserEntityRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
